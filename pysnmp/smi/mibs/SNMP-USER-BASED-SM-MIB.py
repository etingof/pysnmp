...
# by libsmi2pysnmp-0.0.3-alpha at Tue Apr 26 17:40:46 2005,
...
usmUserName = MibTableColumn((1, 3, 6, 1, 6, 3, 15, 1, 2, 2, 1, 2)).setColumnInitializer(MibVariable((), SnmpAdminString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 32))).setMaxAccess("noaccess"))
...
usmUserPublic = MibTableColumn((1, 3, 6, 1, 6, 3, 15, 1, 2, 2, 1, 11)).setColumnInitializer(MibVariable((), OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(0, 32)).subtype('')).setMaxAccess("readcreate"))
