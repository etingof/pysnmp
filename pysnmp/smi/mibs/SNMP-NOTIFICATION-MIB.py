...
snmpNotifyName = MibTableColumn((1, 3, 6, 1, 6, 3, 13, 1, 1, 1, 1)).setColumnInitializer(MibVariable((), SnmpAdminString().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 32))).setMaxAccess("noaccess"))
...
snmpNotifyFilterProfileName = MibTableColumn((1, 3, 6, 1, 6, 3, 13, 1, 2, 1, 1)).setColumnInitializer(MibVariable((), SnmpAdminString().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 32))).setMaxAccess("readwrite"))
...
snmpNotifyFilterMask = MibTableColumn((1, 3, 6, 1, 6, 3, 13, 1, 3, 1, 2)).setColumnInitializer(MibVariable((), OctetString().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 16)).subtype('')).setMaxAccess("readwrite"))
