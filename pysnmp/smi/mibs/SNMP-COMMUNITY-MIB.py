...
# by libsmi2pysnmp-0.0.3-alpha at Wed Nov 10 13:06:01 2004,
...
snmpTargetAddrMMS = MibTableColumn((1, 3, 6, 1, 6, 3, 18, 1, 2, 1, 2)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(484, 2147483647L)).set(484)).setMaxAccess("readcreate"))
