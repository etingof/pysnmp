...
#
# * SNMPv3
# * with SNMP EngineID: 8000000001020304
...
#
# $ snmpwalk -v3 -u usr-md5-des -l authPriv -A authkey1 -X privkey1 -e 8000000001020304 localhost .1.3.6
#
...
# Create SNMP engine
snmpEngine = engine.SnmpEngine(rfc1902.OctetString(hexValue='8000000001020304'))
