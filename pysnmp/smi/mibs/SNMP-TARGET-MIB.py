...
# by libsmi2pysnmp-0.0.3-alpha at Wed Nov 10 13:11:24 2004,
...
snmpTargetSpinLock = MibVariable((1, 3, 6, 1, 6, 3, 12, 1, 1), TestAndIncr()).setMaxAccess("readcreate")
...
snmpTargetParamsSecurityModel = MibTableColumn((1, 3, 6, 1, 6, 3, 12, 1, 3, 1, 3)).setColumnInitializer(MibVariable((), SnmpSecurityModel().addConstraints(subtypes.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readcreate"))
